class OfflineGame
  ...
  def changeTurn
    ...
    if(isStuck(turn) && !(@p2_remaining_playstones > 0) && !(@p1_remaining_playstones > 0))
      @isStuck = turn
    end
    @selected_stone = -1
    removeGhostStones
