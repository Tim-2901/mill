...
class OfflineGame
  ...
  def initialize main
    ...
    @button_action = Button.new(950, 645, ["C:/Users/konop/Documents/mill/assets/game/button_unpressed.png", "C:/Users/konop/Documents/mill/assets/game/button_hover.png"], "Exit", main)
  ...
  def isStuck(turn)
    ...
    positions = []
    for i in 0..occupied.length - 1
      positions = positions.concat(getConnected(occupied[i]))
