...
require 'gosu'
require 'sqlite3'
require_relative 'bin/client/Button'
require_relative 'bin/client/OfflineGame'
require_relative 'bin/client/TextField'
require_relative 'bin/client/game/ClientGame'
require_relative 'bin/client/game/Connection'
require_relative 'bin/client/game/Console'
require_relative 'bin/client/game/ConsoleIngame'
require_relative 'bin/client/game/Field'
require_relative 'bin/client/game/Message'
require_relative 'bin/client/lobby/LoadingCircle'
require_relative 'bin/client/lobby/Lobby'
require_relative 'bin/client/lobby/PlayerData'
require_relative 'bin/server/console'
require_relative 'bin/server/gameserver'
require_relative 'bin/server/server'
require_relative 'bin/server/server/game/Connection'
require_relative 'bin/server/server/game/Player'
